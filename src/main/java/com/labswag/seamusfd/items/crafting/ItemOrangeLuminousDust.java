 ...
 */
public class ItemOrangeLuminousDust extends Item {
    public ItemOrangeLuminousDust() {
        this.setUnlocalizedName("orangeLuminousDust");
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.MODID + ":OrangeLuminousDust");
    }
}
