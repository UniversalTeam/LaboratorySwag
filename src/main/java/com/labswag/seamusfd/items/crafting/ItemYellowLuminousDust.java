 ...
 */
public class ItemYellowLuminousDust extends Item {
    public ItemYellowLuminousDust() {
        this.setUnlocalizedName("yellowLuminousDust");
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.MODID + ":YellowLuminousDust");
    }
}
