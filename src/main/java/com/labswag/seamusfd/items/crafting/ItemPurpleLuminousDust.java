 ...
 */
public class ItemPurpleLuminousDust extends Item {
    public ItemPurpleLuminousDust() {
        this.setUnlocalizedName("purpleLuminousDust");
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.MODID + ":PurpleLuminousDust");
    }
}
