 ...
 */
public class ItemBlackLuminousDust extends Item {
    public ItemBlackLuminousDust() {
        this.setUnlocalizedName("blackLuminousDust");
    ...
    {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.MODID + ":BlackLuminousDust");
    }
}
