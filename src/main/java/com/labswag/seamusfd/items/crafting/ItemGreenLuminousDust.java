 ...
 */
public class ItemGreenLuminousDust extends Item {
    public ItemGreenLuminousDust() {
        this.setUnlocalizedName("greenLuminousDust");
    ...
    public void registerIcons(IIconRegister par1IconRegister) {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.MODID + ":GreenLuminousDust");
    }
}
