 ...
 */
public class ItemBlueLuminousDust extends Item{
    public ItemBlueLuminousDust() {
        this.setUnlocalizedName("blueLuminousDust");
    ...
    {
        this.itemIcon = par1IconRegister.registerIcon(ModInfo.MODID + ":BlueLuminousDust");
    }
}
