...
import com.labswag.seamusfd.models.ModelGrate;
 ...
 */
public class TESRGrate extends TileEntitySpecialRenderer {
    private static final ResourceLocation texture = new ResourceLocation(ModInfo.MODID + ":" + "");
    private ModelGrate model;

    public TESRGrate() {
        this.model = new ModelGrate();
    }
