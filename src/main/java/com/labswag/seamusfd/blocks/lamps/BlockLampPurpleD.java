 ...
 */
public class BlockLampPurpleD extends Block {
    public IIcon icon;
    public BlockLampPurpleD() {
        super(Material.iron);
        this.blockHardness = 10f;
        this.setCreativeTab(ModLabSwag.labSwagTabBlocks);
        this.setBlockName("lampPurpleD");
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegsiter) {
        icon = par1IconRegsiter.registerIcon(ModInfo.MODID + ":lampPurple");
    }
