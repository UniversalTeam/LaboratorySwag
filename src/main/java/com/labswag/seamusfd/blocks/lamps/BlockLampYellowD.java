 ...
 */
public class BlockLampYellowD extends Block {
    public IIcon icon;
    public BlockLampYellowD() {
        super(Material.iron);
        this.blockHardness = 10f;
        this.setCreativeTab(ModLabSwag.labSwagTabBlocks);
        this.setBlockName("lampYellowD");
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegsiter) {
        icon = par1IconRegsiter.registerIcon(ModInfo.MODID + ":lampYellow");
    }
